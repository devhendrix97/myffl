/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 51d65b8d9f1d0922b4410331706eed5b)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APPLICATION_BASE_URL" | "API_BASE_URL" | "EMAIL_FROM_ADDRESS" | "EMAIL_FROM_NAME" | "ACCESS_TOKEN_SIGNING_SECRET" | "REFRESH_TOKEN_HASHING_SECRET" | "PASSWORD_RESET_SECRET" | "EMAIL_VERIFICATION_SECRET" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "VAPID_SUBJECT">> {}
}
