/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 1f4dca6d562ae4541a1aaa4c36f4b5bf)
// Runtime types generated with workerd@1.20260730.1 2026-08-03 nodejs_compat
interface __BaseEnv_Env {
	ASSETS_BUCKET: R2Bucket;
	PROVIDER_ARCHIVE_BUCKET: R2Bucket;
	CORE_DB: D1Database;
	NFL_DB: D1Database;
	LEAGUE_DB_001: D1Database;
	EMAIL: SendEmail;
	ESPN_UPDATES_QUEUE: Queue;
	SCORING_QUEUE: Queue;
	...
	APPLICATION_BASE_URL: "https://app.myfflapp.com" | "https://staging.myfflapp.com" | "http://localhost:5173";
	API_BASE_URL: "https://api.myfflapp.com" | "https://api-staging.myfflapp.com" | "http://localhost:8787";
	EMAIL_FROM_ADDRESS: "noreply@myfflapp.com";
	EMAIL_FROM_NAME: "myFFL";
	FANTASYPROS_SYNC_ENABLED: "true" | "false";
	ACCESS_TOKEN_SIGNING_SECRET: string;
	REFRESH_TOKEN_HASHING_SECRET: string;
	PASSWORD_RESET_SECRET: string;
	EMAIL_VERIFICATION_SECRET: string;
	VAPID_PUBLIC_KEY: string;
	VAPID_PRIVATE_KEY: string;
	VAPID_SUBJECT: string;
	LEAGUE_REALTIME: DurableObjectNamespace<import("./index").LeagueRealtime>;
	MATCHUP_REALTIME: DurableObjectNamespace<import("./index").MatchupRealtime>;
	LIVE_NFL_EVENT: DurableObjectNamespace<import("./index").LiveNflEvent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "LeagueRealtime" | "MatchupRealtime" | "LiveNflEvent";
	}
	...
	interface StagingEnv {
		...
		AUTH_RATE_LIMITER: RateLimit;
		ENVIRONMENT: "staging";
		APPLICATION_BASE_URL: "https://staging.myfflapp.com";
		API_BASE_URL: "https://api-staging.myfflapp.com";
		EMAIL_FROM_ADDRESS: "noreply@myfflapp.com";
		EMAIL_FROM_NAME: "myFFL";
		FANTASYPROS_SYNC_ENABLED: "false";
		ACCESS_TOKEN_SIGNING_SECRET: string;
		REFRESH_TOKEN_HASHING_SECRET: string;
		PASSWORD_RESET_SECRET: string;
		EMAIL_VERIFICATION_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APPLICATION_BASE_URL" | "API_BASE_URL" | "EMAIL_FROM_ADDRESS" | "EMAIL_FROM_NAME" | "FANTASYPROS_SYNC_ENABLED" | "ACCESS_TOKEN_SIGNING_SECRET" | "REFRESH_TOKEN_HASHING_SECRET" | "PASSWORD_RESET_SECRET" | "EMAIL_VERIFICATION_SECRET" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "VAPID_SUBJECT">> {}
}
